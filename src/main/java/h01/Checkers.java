...
public class Checkers {
    ...
    public void doBlackTeamActions() {
        ...
        for (n = 0; n < 4; n++) {
            ...
            if (!isWhiteStonePosition(nextX, nextY) && isWorldPosition(nextX, nextY)) {
                break;
            }
        }
        if (n == 0) {
    ...
    /**
     * Returns if the given position is a position within the world.
     *
     * @param x the x-coordinate of the position
     * @param y the y-coordinate of the position
     * @return if the given position is a position within the world
     */
    private boolean isWorldPosition(int x, int y) {
        return x >= 0 && x < NUMBER_OF_COLUMNS && y >= 0 && y < NUMBER_OF_ROWS;
    }

    /**
     * Returns if the white stone is at the given position.
     *
     * @param x the x-coordinate of the position
     * @param y the y-coordinate of the position
     * @return if the white stone is at the given position
     */
    ...
    /**
     * Returns the black stone with the given number.
     *
     * @param number the number of the black stone
     * @return the black stone with the given number
     */
    ...
    /**
     * Returns the black stone at the given position or {@code null} if there is no black stone at the given position.
     *
     * @param x the x-coordinate of the position
     * @param y the y-coordinate of the position
     * @return the black stone at the given position
     */

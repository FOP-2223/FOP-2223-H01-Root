...
public class CheckersTest {
    ...
    @ParameterizedTest
    @JsonClasspathSource("h01/h2_2_5.json")
    public void testWhiteStoneComplex(
        @Property("id") String id,
        @Property("size") WorldSize size,
        @Property("numberOfCoins") NumberOfCoins numberOfCoins,
        @Property("statesBefore") StoneStates statesBefore,
        ...
        assertEquals(
            statesAfter.blackStone(blackStoneToTurnOff),
            game.getStoneStates().blackStone(blackStoneToTurnOff),
            context,
            r -> format("state of black stone %s is not correct", blackStoneToTurnOff)
        );
    }

    @ParameterizedTest
    @JsonClasspathSource("h01/h2_2_6.json")
    public void testWhiteStoneNoJump(
        @Property("id") String id,
        @Property("size") WorldSize size,
        @Property("numberOfCoins") NumberOfCoins numberOfCoins,
        @Property("statesBefore") StoneStates statesBefore
        ...
        assertEquals(
            ...
            game.getStoneStates(),
            context,
            r -> "states of stones have changed unexpectedly"
        );
    }
    ...
    @ParameterizedTest
    @JsonClasspathSource("h01/h2_3_3.json")
    public void testTeamBlackWinWhenNotAllOn(
        @Property("id") String id,
        @Property("size") WorldSize size,
        @Property("numberOfCoins") NumberOfCoins numberOfCoins,
        @Property("statesBefore") StoneStates statesBefore
